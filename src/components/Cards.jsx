...
function Cards (props) {
    return (
        <>
        <div className="border mr-1 border-gray-300 p-6 w-60 h-full text-center rounded inline-block">
            <img className="ml-6 h-32 w-32 rounded-full mb-3" src={props.img} alt="" />
            <h3 className="text-2xl font-semibold mb-4">Name is {props.username}</h3>
